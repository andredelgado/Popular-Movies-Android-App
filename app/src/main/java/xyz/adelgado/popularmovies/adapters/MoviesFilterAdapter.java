...
public class MoviesFilterAdapter extends BaseAdapter {
  ...
  @Override public View getDropDownView(final int position, View view, ViewGroup parent) {
    if (view == null || !view.getTag()
        .toString()
        .equals(mContext.getString(R.string.dropdown_tag))) {
  ...
  @Override public View getView(final int position, View view, ViewGroup parent) {
    if (view == null || !view.getTag()
        .toString()
        .equals(mContext.getString(R.string.non_dropdown_tag))) {
